...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-server" '("current-buffer-data" "network-vis-options" "org-roam-" "roam-data" "server-css")))
